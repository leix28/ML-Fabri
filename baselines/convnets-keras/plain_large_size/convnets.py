...
def AlexNet(weights_path=None, heatmap=False, nb_classes=14, sz=227):
    ...
    conv_2 = MaxPooling2D((5, 5), strides=(4, 4))(conv_1)
    ...
    K.set_image_data_format(data_format)
    conv_3 = MaxPooling2D((5, 5), strides=(4, 4))(conv_2)
    ...
    K.set_image_data_format(data_format)
    dense_1 = MaxPooling2D((3, 3), strides=(2, 2), name='convpool_5')(conv_3)
    ...
    prediction_new = Dense(nb_classes, activation='softmax', name='dense_3')(dense_2)
