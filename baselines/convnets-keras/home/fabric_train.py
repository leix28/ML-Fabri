...
dataset_fn = '../../../data_preprocessing/id_dataset.txt'
...
if data_augmentation:
    ...
    def predict(model, val=True):
        y_preds = []
        Z = []
        for (x, y, z) in datagenerator.test_generator(dataset_fn, imgs_fn, val=val, sz=img_rows, nb_classes=nb_classes):
    ...
    G = data_gen(dataset_fn, batch_size=batch_size, datagen=datagen, sz=sz, nb_classes=nb_classes)
